                ...
                <div class="quiz-question-container">
                    <div class="row text-start quiz-question-wrapper">
                        ...
                        <div class="col" id="question-1">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>1/7</span> Какой предмет мебели Вас интересует?</h3>
                        ...
                        <div class="col" id="question-2-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>2/7</span> Какая планировка кухни Вам нужна?</h3>
                        ...
                        <div class="col" id="question-3-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>3/7</span> Какие дополнительные особенности кухни Вы хотите?</h3>
                        ...
                        <div class="col" id="question-4-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>4/7</span> Введите размеры кухни</h3>
                        ...
                        <div class="col" id="question-5-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>5/7</span> Какой стиль кухни Вы рассматриваете?</h3>
                        ...
                        <div class="col" id="question-6-kitchen" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>6/7</span> Какой материал фасада Вы рассматриваете?</h3>
                        ...
                        <div class="col" id="question-2-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>2/7</span> Какой тип шкафа Вам нужен?</h3>
                        ...
                        <div class="col" id="question-3-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>3/7</span> Какого типа двери Вы хотите?</h3>
                        ...
                        <div class="col" id="question-4-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>4/7</span> Какой материал фасада Вы хотите?</h3>
                        ...
                        <div class="col" id="question-5-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>5/7</span> Какая ориентировочная ширина шкафа планируется?</h3>
                        ...
                        <div class="col" id="question-6-wardrobe" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>6/7</span> Какое количество дверей Вы предполагаете?</h3>
                        ...
                        <div class="col" id="question-2-other" style="display: none;">
                            <h3 class="quiz-section-subtitle mb-4 text-start"><span>7/7</span> Для расчета опишите Ваше изделие</h3>
