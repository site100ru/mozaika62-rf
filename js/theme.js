...
$(window).scroll(function (e) {
    ...
    $('.parallax-home-section').css('top', (-(scrolled * .25)) + 'px'); // 25 - скорость прокрутки
    $('.parallax-home-section-closets').css('top', (-(scrolled * .25)) + 'px'); // 25 - скорость прокрутки
    $('.index-parallax-home-section').css('top', (-(scrolled * .25)) + 'px'); // 25 - скорость прокрутки
});
